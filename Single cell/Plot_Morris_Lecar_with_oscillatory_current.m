function Plot_Morris_Lecar_with_oscillatory_current(tau_up, tau_down, time, section_time, initPos)
...
% original parametersSine
params = struct('C', 3, 'g_Ca', 6.7, 'g_K', 8, 'g_L', 2,...
                'v_Ca', 120, 'v_K', -84, 'v_L', -80, 'phi', 0.19,...
                'v_1', -1.2, 'v_2', 18, 'v_3', 5.4, 'v_4', 30.1);
step = 0.01;
t_span = 0:step:time;
...
% plot V over t
hold on
plot(t/1000, track1(:, 1), 'k', 'LineWidth', 2); 
axis([0, t_span(length(t_span))/1000, -100, 80]);
xlabel('\itt \rm(s)', 'Fontsize', 14);
ylabel('\itV \rm(mV)', 'Fontsize', 14);

subplot(224);
plot(t/1000, I, 'k', 'LineWidth', 2); 
axis([0, t_span(length(t_span))/1000, -10, 165]);
xlabel('\itt \rm(s)', 'Fontsize', 14);
